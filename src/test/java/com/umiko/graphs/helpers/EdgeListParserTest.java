...
import com.umiko.graphs.Constants;
...
class EdgeListParserTest {
    ...
    @Test
    void parseString() {
        assertThrows(IllegalArgumentException.class, ()->{EdgeListParser.parseString(parseThese[0]);});
        assertThrows(IllegalArgumentException.class, ()->{EdgeListParser.parseString(parseThese[1]);});
        ...
        assertThrows(IllegalArgumentException.class, ()->{EdgeListParser.parseString(parseThese[4]);});
        assertThrows(IllegalArgumentException.class, ()->{EdgeListParser.parseString(parseThese[5]);});
    }
}